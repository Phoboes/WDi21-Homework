...
for ( var i = 0; i < topMovies.length; i += 1) {
    var movies = topMovies[i];
    //console.log("The index is", i);
    console.log("My # " + (i + 1) + " choice movie is " + movies + "." );
}

// KANES VERSION OF ARRAY EXERCISE
...
if ( numOne >= numTwo) {
    console.log( numOne + " is the biggest number");
} else ( numOne <= numTwo) {
    console.log( numTwo + " is the biggest number");
}

function maxOfThree (p3, p4, p5) {
  maxOfThree.splice()
    return maxOfThree
}
