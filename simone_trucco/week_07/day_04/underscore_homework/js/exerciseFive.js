...
// Append a paragraph tag to the body for every person in people. It should end up looking something like this -
// <p> Hello A, you don't look a day over 20 </p>

var newParagraph = "<p> Hello <%= username %>, you don't look a day over <%= age %>!  </p>";

var greeting = _.template( newParagraph );

var personalGreeting = greeting({ username: people[0].username, age: people[0].age });
